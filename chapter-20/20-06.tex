...
Randomisation inference requires knowledge of that assignment mechanism. When treatment is observational or adaptive, as discussed in Sections~\ref{sec:adaptive-experimentation} and~\ref{sec:design-diagnostics}, the mechanism is often unknown or only partially observed, and randomisation-based guarantees may not hold. The theoretical appeal of exactness depends on design information that applied marketing analysts rarely possess.
