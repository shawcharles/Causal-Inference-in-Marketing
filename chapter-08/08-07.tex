...
\item \textbf{Construct intervals:} The 95 per cent confidence interval for $\tau$ is the 2.5th to 97.5th percentile of the bootstrap distribution $\{\hat{\tau}^{(b)}\}_{b=1}^B$.
\end{enumerate}
