...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!50!black,title=Algorithm: ALS for Tensor Completion]
...
\paragraph{Results.} The imputed counterfactuals $\hat{\mathcal{M}}_{ijt}$ represent what sales would have been without the launch. The average treatment effect is 15 per cent increase in sales, with heterogeneity across products (5--30 per cent) and markets (10--25 per cent).
