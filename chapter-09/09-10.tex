...
\paragraph{Results.} The new recommendation algorithm increases click-through rate by 8\% (95\% CI: 5--11\%) and purchase rate by 5\% (95\% CI: 2--8\%). Heterogeneity analysis reveals that power users see a 12\% increase while casual users see only 4\%. Tensor completion reveals this heterogeneity by leveraging the multi-way structure.
...
\paragraph{Results.} Robust matrix completion yields an ATT of 18\% (95\% CI: 14--22\%), compared to 12\% from standard matrix completion, which is biased downward by stockouts. The inventory management system also reduces stockouts by 60\% (from 8\% to 3\% of cells). The robust correction accounts for 6 percentage points of the treatment effect, indicating that half of the sales increase reflects higher demand due to improved product availability.
...
\paragraph{Results.} The overall ATT is 22\% (95\% CI: 18--26\%), with heterogeneity by market size (large markets: 28\%, small markets: 16\%) and income (high-income markets: 25\%, low-income markets: 18\%). The dynamic pattern shows effects growing over time: 15\% at week 4 and 25\% at week 12, reflecting growing consumer awareness. Covariate-assisted tensor completion reveals this heterogeneity by leveraging market characteristics, while the time mode captures the dynamic pattern.
...
\paragraph{Results.} The bidding strategy increases overall CTR by 15\% (95\% CI: 12--18\%) and overall conversion by 10\% (95\% CI: 7--13\%). Platform-specific effects show search at 18\% CTR (95\% CI: 14--22\%) and social at 12\% CTR (95\% CI: 8--16\%). Posterior credible intervals quantify uncertainty, and the hierarchical model reduces standard errors for video by 25\% by borrowing strength from other platforms.
