...
For the Average Treatment Effect on the Treated (ATT), define $p = P(W=1)$ as the marginal treatment probability. Following \citet{santanna2020doubly}, the doubly robust score is:
\[
...
The first term in the DR score uses the outcome regression to predict counterfactuals. The second term reweights control observations to match the treated covariate distribution.
