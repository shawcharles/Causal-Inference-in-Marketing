...
\paragraph{Primary recommendation:} Use never-treated units when available and comparable.

\paragraph{When never-treated sparse:} Use not-yet-treated units, but:
\begin{itemize}
...
\paragraph{Avoid:} Already-treated units as controls (contaminated by their own treatment effects).
...
\begin{tcolorbox}[colback=green!5!white,colframe=green!50!black,title=Summary: Which Assumptions When?]
\paragraph{For event-study designs:}
\begin{itemize}
...
\paragraph{For distributed-lag models:}
\begin{itemize}
...
\paragraph{When parallel trends implausible:}
\begin{itemize}
