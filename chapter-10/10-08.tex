...
Television advertising provides a canonical setting for dynamic methods. The distributed-lag framework has a rich history in advertising response modelling (Tellis et al., 2000; Tellis, 2006). Meta-analytic evidence shows that advertising elasticities average 0.10 in the short run and 0.22 in the long run, with substantial heterogeneity (Sethuraman et al., 2011).
...
\[
\log(\text{Sales}_{it}) = \beta_0 \text{GRP}_{it} + \beta_1 A_{it} + \alpha_i + \lambda_t + \varepsilon_{it},
\]
...
Sethuraman, Tellis, and Briesch conduct a meta-analysis of 751 short-term and 402 long-term advertising elasticities from 56 studies spanning 1960--2008 (Sethuraman et al., 2011).
...
\paragraph{Implications:} Expect modest average effects (10\% elasticity means doubling ad spending increases sales by 10\%) but substantial heterogeneity. Context-specific estimation is essential.
\end{tcolorbox}
...
\[
\log(\text{Sales}_{it}) = \sum_{k = -3}^{+5} \theta_k \mathds{1}\{t - g_{im} = k\} + \alpha_i + \lambda_t + \varepsilon_{it},
\]
