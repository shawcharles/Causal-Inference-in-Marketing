...
Often we are interested in functions of parameters, such as cumulative effects or dynamic paths. This is essential for event studies (Chapter~\ref{ch:event-studies}) and dynamic treatment effect estimation where we report trajectories rather than single coefficients.
