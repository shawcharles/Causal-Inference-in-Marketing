...
Multiplicity considerations arise when testing treatment effects for many post-treatment periods, many cohorts, or many outcomes. Testing each period, cohort, or outcome separately at the 5\% significance level inflates the family-wise error rate (the probability of at least one false rejection).
