...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Box 11.1: Spillover Magnitudes in Practice]
The following stylised scenarios illustrate how spillovers can bias treatment effect estimates. The magnitudes reflect patterns commonly observed in field experiments.

\paragraph{Geographic spillovers (retail).} Treated stores experience a 15\% sales increase, while untreated stores within 5~km experience a 3\% sales decline due to cross-shopping. The net effect is 12\%, compared to the 15\% naive estimate that ignores spillovers. Field experiments in retail consistently find that geographic spillovers attenuate measured treatment effects by 10--30\%.

\paragraph{Network spillovers (social media).} Users with one treated friend are 20\% more likely to adopt a feature, while users with three or more treated friends are 40\% more likely. This non-linear pattern suggests saturation effects as exposure increases.

\paragraph{Competitive spillovers (retail pricing).} A 10\% price cut by the focal store induces a 5\% cut by competitors within 1~km. The direct effect might be a 12\% sales increase, but the net effect is only 8\% after accounting for competitive response.

\paragraph{Implication.} Ignoring spillovers biases treatment effect estimates. The direction of bias depends on spillover sign (positive or negative) and mechanism.
\end{tcolorbox}
