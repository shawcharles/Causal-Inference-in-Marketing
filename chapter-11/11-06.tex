...
Distinguishing the two mechanisms requires examining correlations. If declining effects correlate with competitor actions, competition is the likely cause. If declining effects correlate with aggregate treatment proportion, saturation is the likely cause. If effects decline uniformly across markets regardless of competitor actions or treatment proportion, dynamic decay (Chapter~\ref{ch:dynamics}) is the likely explanation.
\end{tcolorbox}
