...
\textbf{Stage 1: Source Inventory}
\begin{itemize}
...
\textbf{Stage 2: Temporal Alignment}
\begin{itemize}
...
\textbf{Stage 3: Metric-Estimand Alignment}
\begin{itemize}
...
\textbf{Stage 4: Policy Documentation}
\begin{itemize}
...
\textbf{Stage 5: Imperfection Handling}
\begin{itemize}
...
\textbf{Stage 6: Reconciliation and Governance}
\begin{itemize}
    \item Compare estimates across methods (DiD, SC, DML) (Section~\ref{sec:validation-reconciliation}).
    \item Enforce version control, snapshotting, and audit trails (Section~\ref{sec:pipelines-reproducibility}).
...
Table~\ref{tab:metric-estimand-mapping} provides a quick reference for mapping common marketing metrics to their econometric estimands, design constraints, and diagnostic checks.
