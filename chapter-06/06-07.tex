...
A fundamental limitation of synthetic control is the requirement for a long pre-treatment period to learn donor weights. In ``cold-start'' scenarios---a crisis response, product launch in a new market, or entry into a new category---pre-intervention data for the target unit may be unavailable or sparse. This section introduces Causal Data Fusion \citep{yang2024causal}, which addresses cold-start by leveraging an auxiliary reference domain.
