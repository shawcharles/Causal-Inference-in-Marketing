...
\textbf{Software.} Wild cluster bootstrap: \texttt{boottest} in Stata, \texttt{fwildclusterboot} in R. Two-way clustering: \texttt{reghdfe} in Stata, \texttt{fixest} in R. Romano--Wolf: \texttt{rwolf} in Stata, \texttt{wildrwolf} in R. FDR control: \texttt{p.adjust(method="BH")} in R.
