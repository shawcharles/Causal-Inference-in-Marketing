...
\begin{tcolorbox}[colback=green!5!white,colframe=green!50!black,title=Box 18.12: Dynamic Pricing Diagnostic Checklist]
\paragraph{For Algorithmic RDD:}
\begin{itemize}
...
\paragraph{For Spatial Dependence:}
\begin{itemize}
