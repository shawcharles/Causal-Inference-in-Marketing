...
\begin{tcolorbox}[colback=green!5!white,colframe=green!50!black,title=Box 18.13: Paywall Diagnostic Checklist]
\paragraph{For Article Limit RDD:}
\begin{itemize}
...
\paragraph{For Revenue Trade-off:}
\begin{itemize}
