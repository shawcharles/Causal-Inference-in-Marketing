...
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!75!black,title=Box 18.14: Platform Experiment Diagnostic Checklist]
\textbf{For Switchback Experiments:}
\begin{itemize}
...
\textbf{For Graph Cluster Randomisation:}
\begin{itemize}
