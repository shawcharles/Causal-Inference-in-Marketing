...
\paragraph{Purpose} This interlude sets our design-first approach alongside the structural tradition in industrial organisation and marketing science. We clarify the goals, assumptions, and outputs of each approach, and we highlight where each one shines or struggles. We then sketch productive hybrids.
