...
\addlinespace
Staggered adoption (heterogeneous effects) & $\text{ATT}(g,t)$, cohort-specific, event-time $\theta_k$ & Callaway--Sant'Anna, Sun--Abraham, TWFE diagnostics (Chapter~\ref{ch:did}), event study (Chapter~\ref{ch:event}) \\
\addlinespace
