...
The event-study parameter $\theta_k$ aggregates the cohort-specific effects $\tau(g, t)$ across all cohorts $g$ observed at event time $k$:
\[ \theta_k = \sum_{g: g+k \leq T} \omega_{g,k} \, \tau(g, g+k), \]
